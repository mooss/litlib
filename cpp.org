...
Usage:
#+begin_src cpp :eval no-export :exports both
<<include(":noweb print maybe print_size")>>
...
Usage:
#+begin_src cpp :eval no-export :exports both
<<include(":noweb <<vector print vecmaybe")>>
...
void print_veceven(const std::vector<int>& vec) {
    auto res = veceven(vec);
    if(res) {
        print{*res};
    } else {
        print{res.msg()};
...
int main() {
    print_veceven({4, 8, 15, 16, 23, 42});
    print_veceven({4, 8, 16, 42, 108});
}
#+end_src
...
Usage:
#+begin_src cpp :eval no-export :exports both
<<include(":noweb <<vector print maperr maybe")>>
...
void printmap(const std::vector<int>& range) {
    auto res = maperr(even, range);
    if(res) {
        print{*res};
    } else {
        print{res.msg()};
...
int main() {
    printmap({4, 8, 15, 16, 23, 42});
    printmap({4, 8, 16, 42, 108});
}
#+end_src
